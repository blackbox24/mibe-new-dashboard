...
const PackagesPage = () => {
  ...
  const additionalFields = [
    ...
    { name: 'travelType', label: 'Travel Type', type: 'text', required: false },
    { name: 'image', label: 'Image', type: 'file', required: false },
    { name: 'duration', label: 'Duration', type: 'text', required: true },
    { name: 'rating', label: 'Rating (1-5)', type: 'number', required: false },
    { name: 'discountPrice', label: 'Discount Price', type: 'number', required: false },
    { name: 'includes', label: 'Includes', type: 'text', required: false },
    { name: 'excludes', label: 'Excludes', type: 'text', required: false },
    { name: 'itinerary', label: 'Itinerary', type: 'text', required: false },
